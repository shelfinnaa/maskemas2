...
<div class="m-5">
    ...
    <form action="{{ route('order.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group mt-4">
            ...
            <input type="number" name="quantity" class="form-control" id="quantity" placeholder="Insert quantity" required>
        </div>

        <div class="form-group mt-4">
            <label>Total Price (IDR)</label>
            <input type="number" name="total_price" class="form-control" id="total_price" placeholder="Insert price" required>
        </div>
