    ...
    <div class="m-5">
        <div class="row">
            ...
            <div class="col-auto ms-auto">
                <a class="btn btn-success" href="{{ route('admincreateproducttype', ['product_id' => $product->id]) }}"
                    role="button">Add New Product Type</a>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-warning"
                                            href="{{ url('admin/producttype/' . $productType->id . '/edit') }}"
                                            role="button">Update</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-sm btn-danger"
                                            onClick="return confirm('Are you sure, you want to delete this data?')"
                                            href="{{ route('producttypes.delete', ['productTypeID' => $productType->id]) }}"
